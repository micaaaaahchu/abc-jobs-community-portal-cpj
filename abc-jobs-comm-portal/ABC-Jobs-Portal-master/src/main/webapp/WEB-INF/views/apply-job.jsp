							...
							<div class="d-flex justify-content-between">
								<div
									...
									<div class="wrapper d-flex">
										<div class="logo me-3">
											<img src="${apply.getJob().getCompany_image()}"
												alt="${apply.getJob().getCompany_name()}" />
										</div>
										<div class="detail">
									...
									<div class="d-flex ms-0 ms-md-3 mb-3">
										<a href="jobs-search?keyword=${apply.getJob().getJob_level()}"
											class="text-decoration-none">
											<button class="btn btn-outline-secondary me-3">${apply.getJob().getJob_level()}</button>
										</a> <a href="jobs-search?keyword=${apply.getJob().getJob_time()}"
											class="text-decoration-none">
