                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-6">
                                    <div class="card-body p-md-5 text-black">
                                        <h3 class="mb-3 text-uppercase text-center">Edit Thread</h3>
                                        ...
                                        <form:form action="editThread" method="post" modelAttribute="editThread" id="form">
                                            ...
                                            <div class="form-outline mb-2">
                                                ...
                                                <form:select path="tags.first_tag" name="tag1" class="form-select">
                                            ...
                                            <div class="mt-5 d-flex justify-content-center">
                                                <button type="submit" class="btn btn-dark ms-1">Save</button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
