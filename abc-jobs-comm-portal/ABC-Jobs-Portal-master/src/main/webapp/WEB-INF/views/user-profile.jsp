                  ...
                  <div class="p-4 pt-5 position-relative">
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="d-flex flex-column">
                        <a class="btn btn-dark rounded-pill" href="edit-profile"><i class="fas fa-edit me-1"></i>Edit</a>
                      </div>
                    </div>
                    ...
                    <div class="d-flex">
                      <div class="dropdown">
                        <button class="btn btn-outline-dark rounded-pill dropdown-toggle me-3" type="button" data-bs-toggle="dropdown" aria-expanded="false">Add profile section</button>
                      ...
                      <div class="dropdown">
                        <button class="btn btn-outline-secondary rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">More</button>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="edit-profile">Edit Profile</a></li>
                          <li><a class="dropdown-item" href="change-password">Change Password</a></li>
                          <li><a class="dropdown-item" href="change-banner">Change Header</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <section class="profile-section">
                    <div class="d-flex justify-content-between">
                      ...
                      <a href="edit-profile" class="text-decoration-none">
                        <button class="btn btn-outline-secondary rounded-pill"><i class="fas fa-edit me-1"></i>Edit About</button>
                      </a>
                    </div>
